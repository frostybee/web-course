...
---
:::tip
Arrow functions can be defined in several ways, depending on the **number of parameters** and whether you want to use a **block body** or an expression body.
:::

``` javascript title="Examples: Arrow Function Syntax Variations"
