...
## What Are Functions?
:::note
- Functions are **reusable blocks** of code that perform a specific task. They can **take inputs** (parameters), execute a series of statements, and **optionally** return a value. 
