...
## What Is CSS Flexbox?
:::note
- Flexbox (Flexible Box Layout) is a convenient way to distribute space and align items efficiently within **a container** in **one dimension**—either a row or a column .
...
- It's perfect for creating **responsive designs** that adapt to different **screen sizes**. 
:::
...
## How Flexbox Works
:::tip
- Flexbox operates on a **parent-child relationship** model. 
- When applied to a parent element, the parent element becomes a **flex container**, while its immediate children become **flex items**. This relationship forms the foundation of the Flexbox layout system.
- It's super useful for implementing **navigation bars**, **card layouts**, or **centering elements** without the old-school hassle of floats or positioning hacks. 
:::
...
:::tip
Flex container properties control the **layout** and **alignment** of the flex container.
:::
